...
import HistoricalDataTab from 'sections/fundamental-page/tabs/historicalData-tab';
...
StocksHistoryPage.getLayout = function getLayout(page) {
  return <Layout variant="stocks">{page}</Layout>;
};

export default function StocksHistoryPage() {
  return (
